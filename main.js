...
function showData() {
    ...
    listPeople.forEach(function(element, index) {
        ...
        html += '<td><button onclick="deleteData(' + index + ')" class="btn" style="background-color: #FF0000; color: #FFF;">Eliminar dato</button> <button onclick="updateData(' + index + ')" class="btn" style="background-color: #008000; color: #000;">Editar dato</button></td>';
        html += "</tr>";
    });
